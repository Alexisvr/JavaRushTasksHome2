...
public class Solution {
    ...
    public static class Rectangle {
        ...
        /*3 сама задача по вычислению уже решена в переименовываемых методах (не ломать голову)
        4 создать необходимый объект в переименованном методе и в конце вернуть его
        5 "старый" метод вместе с возвращаемым убрать "внутрь"
        6 слова implements и extend не использовать*/
        ...
        public HasWidth castToHasWidth() {
            class HasWidthtImpl implements HasWidth {
                @Override
                public double getWidth() {
                    return Math.abs(point1.getX() - point2.getX());
                }
            }
            return new HasWidthtImpl();
        }
