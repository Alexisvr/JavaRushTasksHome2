...
public class Dog implements Pet {
    ...
    public Sayable toSayable(final int i) {
        ...
        class DogPet extends SuperDog implements Sayable {
            ...
            public String say() {
                if (i < 1) {
                    return String.format(getName() + " спит.");
                } else {
                    return String.format(getName() + " лает г" + repeat("а", i) + "в! " + formatter.format(new Date()));
                }
            }
            ...
            private String getName() {
                return String.format(getSuperQuotes() + name + getSuperQuotes());
            }
        }
